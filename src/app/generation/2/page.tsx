...
//                 </Button>
//               </Link>
//             <h1 className="font-pocket-monk text-6xl px-5">Gen 2</h1>
//             </div>
//             <SpriteGrid generation = "gen2"/>
//             <div className="flex items-center justify-center">
//               <GenerationButtons activeGeneration={2}/>
//             </div>
//         </main>
...
export default async function Gen2Page() {
  const pokemonList = await getPokemon(2);
